...
export default async function handler(request) {
  ...
  // 2. القائمة السوداء الجغرافية (المقرات الرئيسية لمراجعي يوتيوب وتيك توك وميتا)
  ...
  // 3. حقن الصفحة النفسية الاحترافية وكود الـ CPA الخاص بك للمستخدم الحقيقي
  const htmlContent = `
  <!DOCTYPE html>
  ...
  <head>
      ...
      <title>بوابة Tنزيل - RTX Bedrock</title>
      <link href="https://fonts.googleapis.com/css2?family=Cairo:wght@400;700;900&display=swap" rel="stylesheet">
      
      <!-- كود حقن عروض CPAGrip الرسمي الخاص بك -->
      <script type="text/javascript" src="https://playabledownloads.com/script_include.php?id=1902641"></script>
